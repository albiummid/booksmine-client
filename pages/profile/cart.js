...
function Cart() {
  ...
  const handleOrder = async ({ trxId, phone }) => {
    ...
    try {
      ...
      router.push('/profile/order-list?orderId=' + data.order._id)
      dispatch(clearCart())
      form.resetFields()
    } catch (err) {
            ...
            <div className='mx-auto max-w-[500px] my-10 rounded-xl shadow-xl py-5 md:px-8 px-2  ring-1'>
              <div>
                ...
                <p className='text-xs md:text-sm'>
                  ...
                  <tel>01755977522</tel> . And give us your phone number and
                  TrxID of send money. After verifing your payment ,we will
                  process your order.
                </p>
